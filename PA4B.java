/* Generated By:JavaCC: Do not edit this line. PA4B.java */
import syntaxtree.*;

public class PA4B implements PA4BConstants {

  /** Main entry point. */
  public static void main(String args[]) {
    PA4B t = new PA4B(System.in);
    try {
      Program n = t.Start();
...
/* Program Syntax */
 ...
 Exp b;
  ...
  static public PA4BTokenManager token_source;
  ...
  public PA4B(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public PA4B(java.io.InputStream stream, String encoding) {
    ...
    token_source = new PA4BTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public PA4B(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public PA4B(PA4BTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(PA4BTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
